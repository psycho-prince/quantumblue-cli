// test-high.ts
import { generateHybridKeypair, encryptString, decryptString, } from './dist/src/ts/high-crypto.js';
async function runTest() {
    ...
    try {
        ...
        const decrypted = await decryptString(encrypted, privateKeyHex, encrypted.kemCiphertextHex);
